<!-- apps/docs/src/components/examples/chat-message/variants/svelte.svelte -->
<script lang="ts">
  import { ChatMessage } from '@cloudvoyant/vortex-svelte';
</script>
...
<div class="flex w-full max-w-md flex-col gap-4">
  ...
  <ChatMessage variant="user" from="You" at={new Date('2026-09-05T14:33:00')}>A message you sent (user).</ChatMessage>
